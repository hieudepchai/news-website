 ...
 * @author Admin
 */
public class AdminLoginFitlter implements Filter {
    ...
    public AdminLoginFitlter() {
    }

    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("AdminLoginFitlter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("AdminLoginFitlter:DoAfterProcessing");
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("AdminLoginFitlter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("AdminLoginFitlter()");
        }
        StringBuffer sb = new StringBuffer("AdminLoginFitlter(");
