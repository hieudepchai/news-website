        ...
        <div class="container">
                        ...
                        <a href="">
                            <div class="logged-acc">
                                <div class="logged-acc-name">
                                    <c:out value="${CurrentReader.getFirstName()}"></c:out> <c:out value="${CurrentReader.getLastName()}"></c:out>
                                </div>
                                <div class="logged-acc-img">
                                    <c:set var="ProfilePicSrc" value="${CurrentReader.getProfilePicture()}"/>
                                    <c:choose>
                                        <c:when test="${ProfilePicSrc!=null}">
                                            <img class="img-profile rounded-circle" src="${ProfilePicSrc}">
                                        </c:when>
                                        <c:when test="${ProfilePicSrc== null}">
            ...
            <div id="sign-up-container" class="fullscreen-container">
                <div id="sign-up" class="form-popup">
                    ...
                    <form class="form-horizontal sign-up-form form-popup-form" role="form" id="signup-form" action="${pageContext.request.contextPath}/signup" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <input type="text" id ="signup-firstname" name="FirstName"  placeholder="First Name" class="form-control"
                                       autofocus>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="">
                                <input type="text" id="signup-lastname" name="LastName" placeholder="Last Name" class="form-control"
                                       autofocus>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="">
                                <input type="email" id="signup-email" name="Email"  placeholder="Email" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="phone" class=" control-label">Phone number </label>
                            <div class="">
                                <input type="text" id="signup-phone" name="Phone" placeholder="Phone number" class="form-control"
                                       >
                            </div>
                        </div>
            ...
            <div id="login-container" class="fullscreen-container">
                <div id="sign-up" class="form-popup">
                    ...
                    <form class="form-horizontal sign-up-form form-popup-form" id="login-form" role="form" action="${pageContext.request.contextPath}/rlogin">
                        <div class="form-group">
